...
/* BMT 기능테스트용 */
// https://gitlab.com/skdt/blockchain/KONEPS/bmt-contract/-/blob/main/ChainzDoc_BMT.txt
pragma solidity >=0.5.0 <=0.8.18;

contract ChainzDocBMT {
    ...
    */
    ...
    function checkDocument(
        ...
        if( document.expTimestamp > 0 && block.timestamp >= document.expTimestamp ) {
